...
#define defaults_h
  ...
  #define DEFAULT_Y_MAX_RATE 900.0
  ...
  #define DEFAULT_X_MAX_TRAVEL 1235.0 // mm
  #define DEFAULT_Y_MAX_TRAVEL 2100.0 // mm
  ...
  #define DEFAULT_HOMING_FEED_RATE 600.0
  #define DEFAULT_HOMING_SEEK_RATE 600.0
