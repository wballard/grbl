...
#define defaults_h
  ...
  #define DEFAULT_X_MAX_RATE 4000.0
  #define DEFAULT_Y_MAX_RATE 4000.0
  #define DEFAULT_Z_MAX_RATE 4000.0
  #define DEFAULT_X_ACCELERATION (300.0*60*60)
  #define DEFAULT_Y_ACCELERATION (300.0*60*60)
  ...
  #define DEFAULT_HOMING_FEED_RATE 1000.0
